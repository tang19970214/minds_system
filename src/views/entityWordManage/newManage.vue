<template>
  <div class="newManage">
    <div class="newManage__setting" @click="openSearchBox = !openSearchBox">
      <strong>查詢設定</strong>
    </div>

    <transition name="moveR">
      <div class="newManage__searchBox" v-if="openSearchBox">
        <div class="newManage__searchBox--dateRange">
          <div class="sDate">
        ...
        <div class="newManage__searchBox--searchStr">
          <div class="keyword">
            <label>關鍵字：</label>
    ...
    <div class="newManage__listBox">
      <div class="newManage__listBox--add">
    ...
    <!-- modal -->
    <el-dialog class="addWordManageModal" :title="'新增『新詞』'" :visible.sync="openAddWordManage" width="50%" center>
      <el-form :model="addWordManage" :rules="rules_openAddWordManage" ref="ruleForm_openAddWordManage" label-width="130px">
        ...
        <el-form-item label="新詞" prop="Term">
