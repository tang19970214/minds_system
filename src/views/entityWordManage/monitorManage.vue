  ...
  <div class="monitorManage">
    ...
    <transition name="moveR">
      <div class="monitorManage__searchBox" v-if="openSearchBox">
        ...
        <div class="monitorManage__searchBox--searchStr">
          <div class="keyword">
            <label>關鍵字：</label>
    ...
    <!-- modal -->
    <el-dialog class="addWordManageModal" :title="'新增『監控詞』'" :visible.sync="openAddWordManage" width="50%" center>
      <el-form :model="addWordManage" :rules="rules_openAddWordManage" ref="ruleForm_openAddWordManage" label-width="130px">
        ...
        <el-form-item label="監控詞" prop="Term">
