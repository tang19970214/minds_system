<template>
  <div class="synonymManage">
    <transition name="moveT">
      <div class="synonymManage__searchBox" v-if="openSearchBox">
        <div class="synonymManage__searchBox--dateRange">
          <div class="sDate">
        ...
        <div class="synonymManage__searchBox--searchStr">
          <div class="keyword">
            <label>關鍵字：</label>
    ...
    <div class="synonymManage__setting" @click="openSearchBox = !openSearchBox">
      <i class="el-icon-caret-bottom" :class="{'goRound': openSearchBox}"></i>
    </div>

    <div class="synonymManage__listBox">
      <div class="synonymManage__listBox--add">
    ...
    <!-- modal -->
    <el-dialog class="addWordManageModal" :title="'新增『同義詞』'" :visible.sync="openAddWordManage" width="50%" center>
      <el-form :model="addWordManage" :rules="rules_openAddWordManage" ref="ruleForm_openAddWordManage" label-width="130px">
        ...
        <el-form-item label="同義詞" prop="Term">
          <el-input v-model="addWordManage.Term"></el-input>
        </el-form-item>
        <div class="addWordManageModal__remark">
          <p>*例：同義詞1, 同義詞2, 同義詞3, ...</p>
        </div>
